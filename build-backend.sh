...
dotnet publish ./backend/ClefViewer/ClefViewer.API/ClefViewer.API.csproj --no-restore --runtime osx-x64 --output ./publish/osx --self-contained -p:PublishTrimmed=true
